...
RSpec.describe "User management", : type => : system do
  ...
  it "A new user can create an account"
do
  visit "/users/new"
...
it "Does not signup a user if email or username already exits"
do
  visit "/users/new"
...
it "Logs in an existing user with the right parameters"
do
  visit "/users/new"
...
it "Doesn't Logs in a user with an invalid parameters"
do
  visit "/users/new"
...
it "If a User is on the main page and has not signed up, they should click on the signup button on the main page and login after via the login button"
do
  visit "/users"
...
it "A user can log out after signing in via the Accounts button "
do
  visit "/users"
