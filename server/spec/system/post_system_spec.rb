...
it "Allows a signed in user to upload a meme (just attach the image to the form)"
do
...
it "does not upload a post with no image"
do
...
it "does not upload a post with a description"
do
