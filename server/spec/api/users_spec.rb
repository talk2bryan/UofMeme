...
do
  ...
  @user = attributes_for(: user, username: "John", email: "john@myumanitoba.ca"
  , password: "12345678 ",password_confirmation: "12345678 ")
    post "/api/v1/users", @user.as_json end
  ...
  context "when parameters are invalid: password is different from password_co
  nfirmation" do
    before do
    #create_ user
    @user = attributes_for(:user, username: "John" , email: "John@myumanito
    ba.ca", password: "1234678",password_confirmation: "12345678")
  ...
  context "when parameters are invalid: email is not a muymanitoba domain" do
    before do
    #create_ user
    @user = attributes_for(:user, username: "John" , email: "John@mumanitoba
    .ca", password: "12345678",password_confirmation: "12345678")
 ...
 context "when parameters are invalid: username less than 3 characters" do
    before do
    #create_ user
    @user = attributes_for(:user, username: "Jo" , email: "John@mumanitoba.c
    a", password: "12345678",password_confirmation: "12345678")
    post "/api/v1/users", @user.as_json
end
