  ...
  before do
  #create_ user
  @user = attributes_for(:user, username: "John" , email:
  "john@myumanitoba.ca", password: "12345678",password_confirmation: "12345678")
 ...
 before do
 #create_ user
 @user = attributes_for(:user, username: "John" , email: "John@myumanit
 oba.ca", password: "1234678",password_confirmation: "12345678")
 post "/api/v1/users",  @user.as_json
 end
 ...
 before do
 #create_ user
 @user = attributes_for(:user, username: "John" , email: "John@mumanito
 ba.ca", password: "12345678",password_confirmation: "12345678")
 post "/api/v1/users", @user.as_json
end
  ...
  before do
  #create_ user
  @user = attributes_for(:user, username: "Jo" , email: "John@mumanitob
  a.ca", password: "12345678",password_confirmation: "12345678")
  post "/api/v1/users", @user.as_json
  end
