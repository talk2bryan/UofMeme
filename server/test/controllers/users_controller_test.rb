...
post "/users", params: { user: { username: "new_user",
email: "newuser@myumanitoba.ca", password:"password1" } }
assert_response :success
end
...
email: "newuser@myumanitoba.ca", password:"password2" } }
...
post "/users", params: { user: { username: "new_user1",
email: "", password:"password3" } }
assert_select 'div#error_description'
assert_select 'div.alert.alert-danger'
...
get "/users/new"
assert_response :success
post "/users", params: { user: { username: "student",
email: "student@myumanitoba.ca", password:"" } }
assert_select 'div#error_description'
assert_select 'div.alert.alert-danger'
...
post "/users", params: { user: { username: "non_student",
email: "nonstudent@gmail.com", password:"password4" } }
assert_select 'div#error_description'
assert_select 'div.alert.alert-danger'
assert_select 'li', { :count=>1,
:text=>"Email : Enter a valid uofm email address" }
end

test "cannot create a new user with short username" do
get "/users/new"
assert_response :success
post "/users", params: { user: { username: "st",
email: "student@myumanitoba.ca", password:"validpass" } }
assert_select 'div#error_description'
assert_select 'div.alert.alert-danger'
assert_select 'li', { :count=>1,
:text=>"Username is too short (minimum is 3 characters)" }
end
...
post "/users", params: { user: { username: @longUsername,
email: "student@myumanitoba.ca",
password:"validPassword" } }
assert_select 'div#error_description'
assert_select 'div.alert.alert-danger'
assert_select 'li', { :count=>1,
:text=>"Username is too long (maximum is 30 characters)" }
end
...
assert_select 'div.alert.alert-danger'
assert_select 'li', { :count=>1,
:text=>"Password is too long (maximum is 72 characters)" }
end
...
get "/users/new"
assert_response :success
post "/users", params: { user: { username: @newName,
email: "student@myumanitoba.ca", password:"password10" } }
assert_select 'div#error_description'
assert_select 'div.alert.alert-danger'
...
get "/users/new"
assert_response :success
post "/users", params: { user: { username:"valid_name",
email: @newEmail, password:"password10" } }
assert_select 'div#error_description'
assert_select 'div.alert.alert-danger'
