...
def setup@ validUsername = 'memememe'@
validEmail = 'user@myumanitoba.ca'@
validPassword = 'Password'

@
validUser = User.new(username: @validUsername, email: @validEmail, password: @validPassword, password_confirmation: @validPassword)@ validUser2 = User.new(username: 'mickeymouse', email: 'mmouse@umanitoba.ca', password: 'iloveminnie', password_confirmation: 'iloveminnie')
end
