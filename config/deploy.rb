...
# set :ssh_options,     { forward_agent: true, user: fetch(:user), keys: ["config/deploy_id_rsa"] if File.exist?("config/deploy_id_rsa") }
set :ssh_options, { user: "deploy", keys: ["~/.ssh/id_rsa"] }
